...
data4 = np.loadtxt('PeriodicApproxFunction1(100+R*R).dat')
data5 = np.loadtxt('PeriodicApproxFunction1(100+2*R*R).dat')
data6 = np.loadtxt('PeriodicApproxFunction1(100+3*R*R).dat')
